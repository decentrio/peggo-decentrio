...
injectived query ratelimit pending-tx 11 --chain-id=injective-333 --home /Users/nhan/Documents/go-workspace/decentrio/peggo-decentrio/test/cosmos/data/injective-333/n0

# Waiting for 2 minute
sleep 120

echo "--------Checking 11th tx processed-----------"
